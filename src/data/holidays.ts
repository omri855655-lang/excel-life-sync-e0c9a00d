...
const JEWISH_HOLIDAYS_2025: Holiday[] = [
  ...
  { date: "2025-04-19", name: "ערב שביעי של פסח", type: "jewish", color: "#8b5cf6" },
...
const JEWISH_HOLIDAYS_2026: Holiday[] = [
  { date: "2026-03-03", name: "ערב פורים", type: "jewish", color: "#8b5cf6" },
  ...
  { date: "2026-04-08", name: "ערב שביעי של פסח", type: "jewish", color: "#8b5cf6" },
...
const MUSLIM_HOLIDAYS_2025: Holiday[] = [
  ...
  { date: "2025-03-29", name: "ערב עיד אל-פיטר", type: "muslim", color: "#059669" },
  ...
  { date: "2025-06-09", name: "עיד אל-אדחא - יום ג'", type: "muslim", color: "#059669" },
...
const MUSLIM_HOLIDAYS_2026: Holiday[] = [
  { date: "2026-02-17", name: "ערב רמדאן", type: "muslim", color: "#059669" },
  { date: "2026-02-18", name: "רמדאן (תחילה)", type: "muslim", color: "#059669" },
  { date: "2026-03-19", name: "ערב עיד אל-פיטר", type: "muslim", color: "#059669" },
  { date: "2026-03-20", name: "עיד אל-פיטר", type: "muslim", color: "#059669" },
  { date: "2026-03-21", name: "עיד אל-פיטר - יום ב'", type: "muslim", color: "#059669" },
  { date: "2026-05-26", name: "ערב עיד אל-אדחא", type: "muslim", color: "#059669" },
...
const CHRISTIAN_HOLIDAYS_2025: Holiday[] = [
  ...
  { date: "2025-03-05", name: "יום רביעי האפר", type: "christian", color: "#dc2626" },
  { date: "2025-04-13", name: "יום ראשון של הדקלים", type: "christian", color: "#dc2626" },
  { date: "2025-04-17", name: "יום חמישי הקדוש", type: "christian", color: "#dc2626" },
  { date: "2025-04-18", name: "יום שישי הטוב", type: "christian", color: "#dc2626" },
  { date: "2025-04-20", name: "חג הפסחא", type: "christian", color: "#dc2626" },
  { date: "2025-05-29", name: "חג העלייה", type: "christian", color: "#dc2626" },
  { date: "2025-06-08", name: "חג השבועות (פנטקוסט)", type: "christian", color: "#dc2626" },
...
const CHRISTIAN_HOLIDAYS_2026: Holiday[] = [
  ...
  { date: "2026-02-18", name: "יום רביעי האפר", type: "christian", color: "#dc2626" },
  { date: "2026-03-29", name: "יום ראשון של הדקלים", type: "christian", color: "#dc2626" },
  { date: "2026-04-02", name: "יום חמישי הקדוש", type: "christian", color: "#dc2626" },
  { date: "2026-04-03", name: "יום שישי הטוב", type: "christian", color: "#dc2626" },
  { date: "2026-04-05", name: "חג הפסחא", type: "christian", color: "#dc2626" },
  { date: "2026-05-14", name: "חג העלייה", type: "christian", color: "#dc2626" },
  { date: "2026-05-24", name: "חג השבועות (פנטקוסט)", type: "christian", color: "#dc2626" },
