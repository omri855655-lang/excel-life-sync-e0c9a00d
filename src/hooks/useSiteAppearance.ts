...
export const SITE_THEME_PRESETS: SiteThemePreset[] = [
  ...
  { id: "sharp", name: "Sharp", description: "מינימליסטי וחד — קווים נקיים, מונוכרום, בהשראת Apple" },
  { id: "vivid", name: "Vivid", description: "צבעוני ושמח — גוונים חיים ומרקם אנרגטי" },
  { id: "midnight", name: "Midnight", description: "כהה ומקצועי — גוונים עמוקים עם דגשי ניאון" },
