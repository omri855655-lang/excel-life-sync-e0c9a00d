...
export const GUIDES = [
  ...
  },
  {
    ...
    icon: "🌊",
    content: "מצב Flow קורה כשהמשימה מאתגרת בדיוק נכון. 4 תנאים: 1) יעד ברור 2) פידבק מיידי 3) אתגר מותאם 4) ריכוז ללא הפרעות. ZoneFlow עוזר לך ליצור את התנאי הרביעי.",
  },
  {
    id: "deep-work-rules",
