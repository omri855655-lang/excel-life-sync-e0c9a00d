...
const CATEGORY_ITEMS: Record<string, string[]> = {
  "ירקות ופירות": ["עגבניות", "מלפפונים", "בצל", "תפוחי אדמה", "גזר", "פלפלים", "חסה", "אבוקדו", "בננות", "תפוחים", "תפוזים", "לימון", "אננס", "ענבים", "אפרסקים", "שזיפים", "מנגו", "כוסברה", "פטרוזיליה", "שום"],
  "מוצרי חלב": ["חלב", "גבינה לבנה", "גבינה צהובה", "קוטג'", "שמנת", "יוגורט", "חמאה", "ביצים", "שוקו", "לבנה"],
  "בשר ודגים": ["חזה עוף", "שניצל", "בשר טחון", "סטייק", "נקניקיות", "סלמון", "טונה", "דג אמנון", "שוקיים", "כנפיים"],
  "לחם ומאפים": ["לחם לבן", "לחם מלא", "פיתות", "חלה", "לחמניות", "טורטיה", "בייגלה", "קרואסון"],
  "שימורים": ["טונה בפחית", "תירס", "זיתים", "חומוס", "רסק עגבניות", "שימורי ירקות", "אפונה"],
  "חטיפים ומתוקים": ["שוקולד", "ביסלי", "במבה", "עוגיות", "גלידה", "דובונים", "צ'יפס", "אגוזים", "חטיף אנרגיה"],
  "משקאות": ["מים מינרליים", "קולה", "מיץ תפוזים", "בירה", "יין", "סודה", "קפה", "תה"],
  "ניקיון": ["אקונומיקה", "סבון כלים", "מרכך כביסה", "אבקת כביסה", "מגבונים", "שקיות זבל", "ניקוי רצפה"],
  "היגיינה": ["סבון ידיים", "שמפו", "מברשת שיניים", "משחת שיניים", "דאודורנט", "נייר טואלט", "טישו"],
  "קפואים": ["פיצה קפואה", "ירקות קפואים", "שניצלים קפואים", "גלידה", "בצק עלים", "המבורגר קפוא"],
  "תבלינים": ["מלח", "פלפל שחור", "פפריקה", "כורכום", "שום אבקה", "בצל אבקה", "קינמון", "שמן זית", "חומץ"],
};
